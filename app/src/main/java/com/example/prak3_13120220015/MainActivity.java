...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNama = findViewById(R.id.txtStb);
        txtStb = findViewById(R.id.txtNama);
        ...
        tampilkanRingkasan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String nama = txtStb.getText().toString();
                String stb = txtNama.getText().toString();
                ...
                intent.putExtra("prodi", selectedId == R.id.radioGroup ? "Teknik Infomatika" : "Sistem Informasi");
